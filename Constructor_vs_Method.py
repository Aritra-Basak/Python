...
c2=School2()
c2.show(1,2,3)
#We need to pass self every time when we pass values or arguments in a method or in a constructor cause while creating object of it's respective classes that object is also passed and that object is passed through self as an argument.
